...
// 프로필 보기
userAuthRouter.get('/user/:userId', login_required, userController.findByUserId);

// 프로필 수정
userAuthRouter.put('/user/:id', login_required, userController.setUserInfo);

// 내 정보 보기
userAuthRouter.get('/currentUser', login_required, userController.getCurrentUser);

// 계정 삭제
userAuthRouter.delete('/user/:id', login_required, userController.deleteAccount);
